...
def part_2() -> int:
    ...
    for i in range(0, len(all_lines), 6):
        ...
        common_letter_group_1 = list(
            set(group_1_rucksack_1).intersection(group_1_rucksack_2, group_1_rucksack_3)
        )[0]
        common_letter_group_2 = list(
            set(group_2_rucksack_1).intersection(group_2_rucksack_2, group_2_rucksack_3)
        )[0]
